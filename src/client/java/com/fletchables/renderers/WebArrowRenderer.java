...
public class WebArrowRenderer<T extends PersistentProjectileEntity>
    extends EntityRenderer<T, ProjectileEntityRenderState> {
  private final Identifier texture;
  private final WebArrowModel model;

  public WebArrowRenderer(EntityRendererFactory.Context context, Identifier texture) {
    super(context);
    this.texture = texture;
    this.model = new WebArrowModel(context.getPart(ModModelLayers.WEB_ARROW_MODEL_LAYER));
  }
