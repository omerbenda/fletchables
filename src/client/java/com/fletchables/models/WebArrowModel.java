...
public class WebArrowModel extends EntityModel<ProjectileEntityRenderState> {
  public WebArrowModel(ModelPart root) {
  ...
  public static TexturedModelData getTexturedModelData() {
    ...
    modelPartData.addChild(
        "front",
        ModelPartBuilder.create().uv(10, 0).cuboid(8.0F, -2.5F, -2.5F, 0.0F, 5.0F, 5.0F),
